	...
	return (
		...
		>
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_id', value )
				}
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_city', value )
				}
			/>
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_state', value )
				}
			/>
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_zip', value )
				}
			/>
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_country', value )
				}
			/>
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_lat', value )
				}
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_long', value )
				}
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_url', value )
				}
				type="url"
			...
			<TextControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_venue_color', value )
				}
				type="color"
			...
			<ToggleControl
				...
				onChange={ ( value ) =>
					updateMeta( '_eventive_use_reserved_seating', value )
				}
				help={ __(
